...
export default function PricingCalculatorSection() {
    return (
        <section className="max-w-[1400px] px-0 md:px-6 lg:px-8 bg-white pt-14 pb-8 md:pt-16 md:pb-10 flex justify-center">
            <div className="w-full mx-4 md:mx-auto bg-gradient-to-br from-[#0f2557] via-[#1e3a8a] to-[#2563eb] rounded-[16px] px-6 py-8 md:p-10 flex flex-col md:flex-row items-center gap-12 relative overflow-hidden">
                {/* 
                            ...
                            <div className="flex-1 flex flex-col gap-6">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <input
                                        ...
                                        className="bg-transparent border border-white text-[14px] rounded-[8px] px-4 py-[10px] placeholder-white/70 focus:outline-none transition-colors"
                                    />
                                </div>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <input
                                            ...
                                            className="w-full bg-transparent border border-white text-[14px] rounded-[8px] px-4 py-[10px] placeholder-white/70 focus:outline-none transition-colors"
                                        />
                            ...
                            <div className="flex-1 flex flex-col gap-6">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="flex items-center gap-3 text-white/60">
                                        <input type="text" placeholder="Length" className="w-full bg-transparent border border-white text-center rounded-[8px] px-[10px] py-[10px] text-[14px] placeholder-white/70 focus:outline-none" />
                                        <span className="text-white">X</span>
                                        <input type="text" placeholder="Width" className="w-full bg-transparent border border-white text-center rounded-[8px] px-[10px] py-[10px] text-[14px] placeholder-white/70 focus:outline-none" />
                                        <span className="text-white">X</span>
                                        <input type="text" placeholder="Height" className="w-full bg-transparent border border-white text-center rounded-[8px] px-[10px] py-[10px] text-[14px] placeholder-white/70 focus:outline-none" />
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="number"
                                            placeholder="2000"
                                            className="w-full bg-transparent border border-white text-[14px] rounded-[8px] px-4 py-[10px] pl-8 placeholder-white/70 focus:outline-none transition-colors"
                                        />
                                    </div>
                                </div>
                            </div>
